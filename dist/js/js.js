...
let menuLines = document.querySelector('.btn-lines');
let menuMobBox = document.querySelector('.menu');
let menuItem = document.querySelectorAll('.menu-item');

if(menuBtn) {
  menuBtn.addEventListener('click', function() {
    menuLines.classList.toggle("btn-lines-active");
...
menuItem.forEach(function(btn) {
  btn.addEventListener('click', function() {
    menuLines.classList.remove("btn-lines-active");
